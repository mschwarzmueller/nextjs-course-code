...
class DevServer extends _nextServer.default {
        ...
        if ((0, _isError).default(err) && err.stack) {
            try {
                ...
                if (frame.lineNumber && (frame == null ? void 0 : frame.file)) {
                    ...
                    const compilation = src === "edge-server" ? (ref = this.hotReloader) == null ? void 0 : (ref7 = ref.edgeServerStats) == null ? void 0 : ref7.compilation : (ref8 = this.hotReloader) == null ? void 0 : (ref9 = ref8.serverStats) == null ? void 0 : ref9.compilation;
                    const source = await (0, _middleware).getSourceById(!!((ref10 = frame.file) == null ? void 0 : ref10.startsWith(_path.sep)) || !!((ref11 = frame.file) == null ? void 0 : ref11.startsWith("file:")), moduleId, compilation);
    ...
    async ensureEdgeFunction(pathname) {
    ...
    generateRoutes() {
        ...
        fsRoutes.unshift({
            ...
            fn: async (_req, res)=>{
                res.statusCode = 200;
                res.setHeader("Content-Type", "application/json; charset=utf-8");
                res.body(JSON.stringify(this.middleware ? {
