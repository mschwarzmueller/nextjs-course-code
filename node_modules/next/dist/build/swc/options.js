...
function getBaseSWCOptions({ filename , jest , development , hasReactRefresh , globalWindow , nextConfig , resolvedBaseUrl , jsConfig , swcCacheDir ,  }) {
    ...
    var ref11;
    const plugins = ((ref11 = nextConfig == null ? void 0 : (ref4 = nextConfig.experimental) == null ? void 0 : ref4.swcPlugins) != null ? ref11 : []).filter(Array.isArray).map(([name, options])=>[
...
function getEmotionOptions(nextConfig, development) {
    var ref, ref13, ref14, ref15, ref16, ref17, ref18;
    if (!(nextConfig == null ? void 0 : (ref = nextConfig.compiler) == null ? void 0 : ref.emotion)) {
        return null;
    }
    let autoLabel = false;
    switch(nextConfig == null ? void 0 : (ref13 = nextConfig.compiler) == null ? void 0 : (ref14 = ref13.emotion) == null ? void 0 : ref14.autoLabel){
        case "never":
            autoLabel = false;
            break;
        case "always":
    ...
    return {
        enabled: true,
        autoLabel,
        labelFormat: nextConfig == null ? void 0 : (ref15 = nextConfig.experimental) == null ? void 0 : (ref16 = ref15.emotion) == null ? void 0 : ref16.labelFormat,
        sourcemap: development ? (ref19 = nextConfig == null ? void 0 : (ref17 = nextConfig.experimental) == null ? void 0 : (ref18 = ref17.emotion) == null ? void 0 : ref18.sourceMap) != null ? ref19 : true : false
    };
}
...
function getLoaderSWCOptions({ filename , development , isServer , pagesDir , isPageFile , hasReactRefresh , nextConfig , jsConfig , supportedBrowsers , swcCacheDir ,  }) {
    let baseOptions = getBaseSWCOptions({
        filename,
        development,
        globalWindow: !isServer,
